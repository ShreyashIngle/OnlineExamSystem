  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><span style="color:cyan;font-family:Montserrat, sans-serif; font-size: 20px !important;letter-spacing: 4px; "><b>LOGIN -ADMIN</b></span></h4>
      </div>
...
<div class="form-group">
  ...
  <div class="col-md-6"> 
    <input  type="submit"  style="background:#00FFFF;" class="sub" value="sign up"  />
  </div>
</div>
</fieldset>
</form>
...
<div id="services" class="container-fluid text-center">
  ...
  <div class="row slideanim">
    <div class="col-sm-4">
      ...
      <i class="material-icons" style="font-size:60px;color:cyan">group_add</i>
      <h4>e Examination</h4>
...
<div id="developers" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="https://media.licdn.com/dms/image/D5603AQGIlmw1A1cLXg/profile-displayphoto-shrink_400_400/0/1666532243915?e=1718236800&v=beta&t=y97tIo5a-zEkoTo5OzL48_UmbcLB2jwZ_PrE66brByA" alt="SHREYASH" width="300" height="200" style="border-radius: 50%;padding-top: 10px">
        <p><strong>SHREYASH RAJESH INGLE</strong></p>
        <a href="https://www.linkedin.com/in/shreyash-rajesh-ingle" style="text decoration:none; text color:#00FFFF;font-size: 15px">Linkedin</a>
        <p>PICT 2nd YEAR</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="photo.jpg" alt="SMIT" width="400" height="300">
        <p><strong>SMIT RAJESH DESHMUKH</strong></p>
        <a href="https://www.linkedin.com/in/smit-deshmukh-99048625a/" style="text decoration:none; text color:#00FFFF;font-size: 15px">Linkedin</a>
        <p>PICT 2nd YEAR</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="https://media.licdn.com/dms/image/D4D03AQGukgz205Ldrg/profile-displayphoto-shrink_400_400/0/1707647727954?e=1718236800&v=beta&t=_mp1q8nA0NufBHcreDuJDMsXq-0RAP2h-lld8yUIqwc" alt="SARANG" width="300" height="200" style="border-radius: 50%;padding-top: 10px">
        <p><strong>SARANG YOGESH SHUKLA</strong></p>
        <a href="https://www.linkedin.com/in/sarang-shukla-171144260/" style="text decoration:none; text color:#00FFFF;font-size: 15px">Linkedin</a>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-envelope"></span> Pune Institute of Computer Technology</p>
    </div>
